...
> Don't want to install uv? You can also use a local Python (≥3.10) with `pip install -r requirements.txt` then `python -m cubism_mcp`, but you'll manage dependencies yourself.
